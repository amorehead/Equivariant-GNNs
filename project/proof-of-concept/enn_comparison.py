...
print(
    f'The original SE(3)-Transformer, with an equivariance error of {str(diff)}, takes {str(t2 - t1)} seconds to perform 100 forward passes.')
...
diff = (output1 - output2).max()
print(
    f'The new SE(3)-Transformer, with an equivariance error of {str(diff)}, takes {str(t2 - t1)} seconds to perform 100 forward passes.')
...
diff = (output1 - output2).max()
print(
    f'The open-source EGNN, with an equivariance error of {str(diff)}, takes {str(t2 - t1)} seconds to perform 100 forward passes.')
