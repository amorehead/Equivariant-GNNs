...
import project.utils.from_se3cnn.utils_steerable
...
def _test_spherical_harmonics(order):
    ...
    with torch_default_dtype(torch.float64):
        ...
        Yrx = project.utils.from_se3cnn.utils_steerable.spherical_harmonics(order, ra, rb)

        Y = project.utils.from_se3cnn.utils_steerable.spherical_harmonics(order, a, b)
